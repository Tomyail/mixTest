package com.nodename.Delaunay
{
	...
	public final class Halfedge
	{
		...
		//public static function create(edge:Edge, lr:int):Halfedge
		//{
			//if (_pool.length > 0)
			//{
		...
		public var leftRight:int;
		public var vertex:Vertex;
		
		// the vertex's y-coordinate in the transformed Voronoi space V*
		public var ystar:Number;

		public function Halfedge(edge:Edge = null, lr:int = 0)
		{
		...
		//private function init(edge:Edge, lr:int):Halfedge
		//{
			//this.edge = edge;
			//leftRight = lr;
			//nextInPriorityQueue = null;
		...
		public function isLeftOf(p:Point):Boolean
		{
			...
			var tsp:Point = topSite.coord;
			rightOfSite = p.x > tsp.x;
			...
			if (edge.a == 1.0)
			{
				...
				if (!fast)
				{
					dxs = tsp.x - edge.leftSite.coord.x;
